# alias，自用，适用于archlinux 和slackware
...
# }
# 系统嗲用查询
alias grepsyscall_32='/usr/bin/env cat /usr/include/asm/unistd_32.h | /bin/grep -P '
alias grepsyscall_64='/usr/bin/env cat /usr/include/asm/unistd_64.h | /bin/grep -P '
# vim 式退出登录
alias quit='exit'
alias q='quit'
alias :q='q'
